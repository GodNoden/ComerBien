          ...
          Object.entries(dayMeals as any).forEach(([mealType, recipeIds]) => {
            if (Array.isArray(recipeIds)) {
              convertedMealPlan[day as keyof MealPlan][mealType as keyof DayMeals] = recipeIds
                .map((id: number) => sampleRecipes.find(recipe => recipe.id === id))
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Weekly Menu</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-6">
          {Object.entries(mealPlan).map(([day, dayMeals], index) => {
            ...
            return (
              ...
              >
                <Card className={`h-fit backdrop-blur-sm border-white/40 shadow-lg hover:shadow-xl transition-all duration-300 group ${
                  isEmpty 
                  ...
                  <CardHeader className={`pb-4 rounded-t-lg ${
                    ...
                    <CardTitle className={`text-lg text-center font-bold transition-colors ${
                      isEmpty 
                    ...
                    {isEmpty ? (
                      ...
                      <>
                        ...
                        {/* Macro percentages with progress bars */}
                        {totalMacros > 0 && (
        ...
        {Object.values(mealPlan).every((dayMeals: DayMeals) => 
          ...
          <div className="text-center py-12 animate-fade-in">
            ...
            <p className="text-muted-foreground mb-4">Click the + buttons to add meals to your weekly menu</p>
            <Button 
              onClick={() => navigate('/')} 
